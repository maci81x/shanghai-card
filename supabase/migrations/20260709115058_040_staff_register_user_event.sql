-- 20260709115058_040_staff_register_user_event
...
BEGIN
  ...
  WHERE user_id = v_user.id AND event_id = p_event_id AND registration_type = 'socio';
  IF FOUND THEN
  ...
  INSERT INTO event_registrations (user_id, event_id, registration_type, payment_status, amount, operator_id)
  VALUES (v_user.id, p_event_id, 'socio', 'da_saldare', v_event.price, p_operator_id)
