-- 20260709115205_040c_fix_staff_register_no_operator
...
BEGIN
  ...
  INSERT INTO event_registrations (user_id, event_id, payment_status, amount)
  VALUES (v_user.id, p_event_id, 'da_saldare', v_event.price)
